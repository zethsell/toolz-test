...
function AuthLayout({content}: Props) {
    return (
        <div className="bg-[#F9F9F9] dark:bg-[#232323] h-full md:w-full inline-flex overflow-auto md:overflow-hidden">
            <BannerLogin/>
            <div className=" w-full md:w-[692px] md:p-[24px] h-full gap-[8px]">
                <div
                    className="h-[96px] w-full md:w-[644px] flex justify-between p-6 items-center md:border-none border-b border-black border-opacity-10 dark:border-white dark:border-opacity-10">
